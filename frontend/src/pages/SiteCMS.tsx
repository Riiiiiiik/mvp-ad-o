        ...
        <AdminLayout activePath="#/admin/cms">
            <div className="p-8">
                <header className="flex justify-between items-center mb-10">
                    <div>
                        <h1 className="text-3xl font-black text-white tracking-tighter uppercase">Controle da Vitrine</h1>
                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-[0.2em] mt-1">Gerencie Banners, Textos e Contatos</p>
                    </div>
                    <button
                        onClick={handleSave}
                        disabled={saving}
                        className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-2xl text-xs font-black uppercase tracking-widest transition-all shadow-lg shadow-blue-600/20 disabled:opacity-50"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-8">
                        <section className="bg-slate-900/40 border border-slate-800/50 p-8 rounded-[2.5rem] backdrop-blur-sm">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-slate-950 border border-slate-800/50 rounded-2xl px-5 py-4 mt-2 text-sm text-white focus:outline-none focus:border-blue-500/50 transition-colors min-h-[100px]"
                                    />
                                </div>
                                <div>
                                    <label className="text-[10px] text-slate-500 font-black uppercase tracking-widest ml-1">Imagem de Fundo</label>
                                    <div className="mt-2 flex items-center gap-4">
                                        <label className="cursor-pointer bg-slate-800 hover:bg-slate-700 text-white px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-colors">
                                            Selecionar Imagem
                        ...
                        <section className="bg-slate-900/40 border border-slate-800/50 p-8 rounded-[2.5rem] backdrop-blur-sm">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label className="text-[10px] text-slate-500 font-black uppercase tracking-widest ml-1">WhatsApp (Apenas Números)</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="text-[10px] text-slate-500 font-black uppercase tracking-widest ml-1">Horário de Funcionamento</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="text-[10px] text-slate-500 font-black uppercase tracking-widest ml-1">E-mail de Contato</label>
                                    <input
                                        type="email"
                    ...
                    <div className="sticky top-8 space-y-6">
                        ...
                        {/* Hero Preview */}
                        <div className="relative w-full max-w-[320px] mx-auto aspect-[9/16] bg-slate-950 rounded-[3rem] border-[8px] border-slate-900 shadow-2xl overflow-hidden">
